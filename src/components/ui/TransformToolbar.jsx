      ...
      {selectedId && (
        <div style={{
          ...
          <button onClick={() => handleRotateSelected(-Math.PI / 4)} title="Putar -45°" style={{
            padding: '4px 10px', borderRadius: 6, border: 'none', background: isNight ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.05)', color: isNight ? '#E5E5E5' : '#171717', cursor: 'pointer', fontWeight: 600, fontSize: 11, letterSpacing: '0.5px', transition: 'all 0.2s'
          }}>-45°</button>
          <button onClick={() => handleRotateSelected(Math.PI / 4)} title="Putar +45°" style={{
            padding: '4px 10px', borderRadius: 6, border: 'none', background: isNight ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.05)', color: isNight ? '#E5E5E5' : '#171717', cursor: 'pointer', fontWeight: 600, fontSize: 11, letterSpacing: '0.5px', transition: 'all 0.2s'
          }}>+45°</button>
          ...
          <button onClick={handleDeleteSelected} style={{
            padding: '4px 10px', borderRadius: 6, border: '1px solid rgba(239, 68, 68, 0.5)', background: 'transparent', color: '#ef4444', cursor: 'pointer', fontWeight: 600, fontSize: 11, letterSpacing: '0.5px', transition: 'all 0.2s'
          }}>DELETE</button>
        </div>
      )}
